...
export const IconsArray = Object.keys(IconFamilies).reduce<
  { name: string; value: unknown; family: string }[]
>((arr, family) => {
  let icons = IconFamilies[family as keyof typeof IconFamilies];
  return [
    ...arr,
